...
public class Solution extends AbstractList<String> implements List<String>,Cloneable,Serializable{
    ...
    void linkLast(String var1) {
        root = insert(root, var1, null);
    }

    private Node insert(Node current, String data, Node parent) {
        if (current == null) {
            current = new Node(parent, data, null, null);
    ...
    private static class Node<String> {
        ...
        Node(Solution.Node<String> prev, String item, Solution.Node<String> left, Solution.Node<String> right) {
            this.prev = prev;
            this.item = item;
            this.left = left;
            this.right = right;
